...
extra.master.colnames <- 
  make.names(colnames(extra.master),unique = TRUE, allow_ = TRUE)
ordinary.master.colnames <- 
  make.names(colnames(ordinary.master), unique = TRUE, allow_ = TRUE)
equity.master.colnames <- 
  make.names(colnames(equity.master), unique = TRUE, allow_ = TRUE)
deposit.master.colnames <- 
  make.names(colnames(deposit.master), unique = TRUE, allow_ = TRUE)
options.master.colnames <- 
  make.names(colnames(options.master), unique = TRUE, allow_ = TRUE)
futures.master.colnames <- 
  make.names(colnames(futures.master), unique = TRUE, allow_ = TRUE)
i.margin.master.colnames <- 
  make.names(colnames(i.margin.master), unique = TRUE, allow_ = TRUE)
forwards.master.colnames <-
  make.names(colnames(forwards.master), unique = TRUE, allow_ = TRUE)
overnight.master.colnames <- 
  make.names(colnames(overnight.master), unique = TRUE, allow_ = TRUE)
...
# WRITE TO SQL 
path <- "/Users/ndflip7/documents/a-rpa/dailyreport/database/dailyreport.db"
